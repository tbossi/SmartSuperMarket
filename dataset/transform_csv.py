...
df.rename(columns = {'reparto' : 'department', 'price' : 'original'}, inplace = True)
json_file = (df.groupby(['index', 'department', 'title', 'availability'], as_index = False)
			  .apply(lambda x: {
